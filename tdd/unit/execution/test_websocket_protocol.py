...
DORMANT until Phase 12.6 implements app.services.execution.runner_protocol;
the importorskip gate below vanishes on its own the moment that module lands.
...
# 12.6 dormancy gate (R4): skips this whole module with a baselined reason
# until the target lands; runs the suite automatically once it exists.
pytest.importorskip(
    "app.services.execution.runner_protocol",
    reason="12.6-dormant: app.services.execution.runner_protocol lands in Phase 12.6",
)
